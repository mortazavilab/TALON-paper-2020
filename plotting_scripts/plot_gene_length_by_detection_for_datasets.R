...
load_packages <- function() {
    ...
    source("/data/users/freese/mortazavi_lab/bin/TALON-paper-2020/analysis_scripts/filter_kallisto_illumina_genes.R")
    source("/data/users/freese/mortazavi_lab/bin/TALON-paper-2020/analysis_scripts/filter_kallisto_illumina_transcripts.R")
    source("/data/users/freese/mortazavi_lab/bin/TALON-paper-2020/analysis_scripts/get_database_transcript_table.R")
